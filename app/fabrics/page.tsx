    ...
    <main>
      <section className="pageHero">
        ...
        <div className="hero-meta">
          <span>12 / LISTED QUALITIES</span>
          <span>B2B / BULK SOURCING</span>
      ...
      <section className="section catalogueSection">
        <div className="container">
          <div className="section-head">
            <div>
              <div className="eyebrow">Browse qualities</div>
              <h2>Our working fabric range.</h2>
            </div>
            <p>
              Trade names and indicative specifications are shown for discovery. Exact composition, width, GSM, construction and finish should be confirmed against the available lot before an order is placed.
            </p>
          </div>
      ...
      <section className="band">
        <div className="container band-inner">
          <div>
            ...
            <h2>Have a fabric reference, sample or target specification?</h2>
            <p className="lead">
              Send the fabric name or reference along with your required quantity and intended application. We can discuss the appropriate sourcing route.
            </p>
            <Link className="button buttonDark" href="/contact">Start an enquiry</Link>
          </div>
          <div className="list">
            <div><span>Useful details</span><strong>Fabric name</strong></div>
            <div><span>Specification</span><strong>Width / GSM / finish</strong></div>
            <div><span>Commercial</span><strong>Required quantity</strong></div>
            <div><span>Application</span><strong>Garment / dress material</strong></div>
          </div>
        </div>
      </section>
    </main>
